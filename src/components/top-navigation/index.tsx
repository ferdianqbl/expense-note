...
const TopNavigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 sm:max-w-lg mx-auto grid grid-cols-3 dark:bg-black px-4 py-2 border-b z-10 dark:border-zinc-600 whitespace-nowrap bg-white items-center">
