...
const BottomNavigation = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 sm:max-w-md mx-auto grid grid-cols-3 px-4 py-2 sm:px-0 border-t z-10 dark:border-zinc-600 items-center bg-background">
      <Link href={"/"}>
        <Button
          variant={"ghost"}
